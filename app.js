...
player.img.src = "https://i.pinimg.com/originals/95/ca/f2/95caf2485c9e224a94a059377604c63f.png";
...
function createEnemy(dxdy){
    ...
    var img = new Image();
    img.src = "https://orig00.deviantart.net/b81a/f/2014/324/f/d/top_down_zombie_walk_by_mmantas-d872eu2.png"
...
function createBullet(x, y, dx, dy, rot){
    if(ammo > 0){
    var img = new Image();
    img.src = "http://pixelartmaker.com/art/9d5278583d9297d.png"
...
function lifeLevel(){
    ...
    else if(totalEnemies < 260){
        level = 6;
    }
    else if(totalEnemies < 320){
        level = 7;
    }
    else if(totalEnemies < 400){
        level = 8;
    }
    else if(totalEnemies < 500){
        level = 9;
    }
    else{
        level = 10;
...
window.onload = function(){
    ...
    setInterval(function(){
        ...
        if(level == 1){
            ...
            createEnemy([[6, 0], [-6, 0], [0, 6], [0, -6]]);
        }
        else if(level == 3){
            createEnemy([[7, 0], [-7, 0], [0, 7], [0, -7]]);
            createEnemy();
        }
        else if(level == 4){
            ...
            createEnemy([[11, 0], [-11, 0], [0, 11], [0, -11]]);
            createEnemy();
        }
        else if(level == 6){
